...
const CourseFullStack = (props) => {
    return(
        <Layout>
            ...
            <Navbar />
            <BGClick />
            <Page2Top course="fullstack" title="Full-Stack Web Development" top="Online | 6 Weeks | Lively Mentorship | 4 Weeks Job Assistance" line1="(From Scratch)" line2="Become a Full-Stack developer to skill up & get a job" type="fullstack" illustration={fullStackBG} />
