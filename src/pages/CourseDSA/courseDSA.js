...
const CourseDSA = (props) => {
    return(
        <Layout>
            ...
            <Navbar />
            <BGClick />
            <Page2Top course="dsa" title="Data Structures and Algorithms" top="Online | 3 Months | Live Mentorship | Interview + Job Assistance" line1="From Scratch" line2="Implement Data Structures and crack coding interviews"  line3_1 = "₹ 42,000" line3_2 = "₹ 45,000" type="fullstack" illustration={dsaBG} />
