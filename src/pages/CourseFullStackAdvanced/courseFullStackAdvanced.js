...
import fullStackadvancedBG from '../../assets/fullstackadvanced.jpg'

const CourseFullStackAdvanced = (props) => {
    return(
        <Layout>
            <MenuModal />
            <Navbar />
            <BGClick />
            <Page2Top title="Full-Stack Web Development (From Scratch)" top="Online | 6 Weeks | Lively Mentorship | 4 Weeks Job Assistance" line1="Become a Full-Stack developer to skill up & get a job" line2="Rated by students" type="fullstack" illustration={fullStackadvancedBG} />
...
export default CourseFullStackAdvanced;