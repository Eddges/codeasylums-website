        ...
        <div className="timeline">
            ...
            <div className="timeline-wrapper">
                <div className="timeline-slider">
                    <div className="timeline-slide monday" style={{backgroundImage : `url(${mentor})`}} data-year="Mentorship"> <span className="timeline-year">Mentorship</span>
                    ...
                    <div className="timeline-slide tuesday" style={{backgroundImage : `url(${caseStudy})`}} data-year="Assignments"> <span className="timeline-year">Assignments</span>
                        <div className="timeline-slide__content">
                    ...
                    <div className="timeline-slide wednesday" style={{backgroundImage : `url(${contest})`}} data-year="Hackathons"> <span className="timeline-year">Hackathons</span>
                        <div className="timeline-slide__content">
                    ...
                    <div className="timeline-slide thursday"style={{backgroundImage : `url(${discussion})`}} data-year="Interviews"> <span className="timeline-year">Interviews</span>
                        <div className="timeline-slide__content">
