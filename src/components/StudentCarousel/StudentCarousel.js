        ...
        <div className="timeline">
            ...
            <div className="timeline-wrapper">
                <div className="timeline-slider">
                    ...
                    <div className="timeline-slide"  data-year="1988"> <span className="timeline-year">Tuesday</span>
                        <div className="timeline-slide__content">
                    ...
                    <div className="timeline-slide"  data-year="1998"> <span className="timeline-year">Wednesday</span>
                        <div className="timeline-slide__content">
                    ...
                    <div className="timeline-slide" data-year="2006"> <span className="timeline-year">Thursday</span>
                        <div className="timeline-slide__content">
                            <h4 className="timeline-title">Our nice super title</h4>
                            <p className="timeline-text">Lorem ipsum dolor site amet, consectetur adipscing elit, sed do eisumod tempor incididut ut labore et dolore magna aliqua. Ut enim ad mimim venjam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                        </div>
                    </div>
                    <div className="timeline-slide"  data-year="2008"> <span className="timeline-year">Friday</span>
                        <div className="timeline-slide__content">
                            <h4 className="timeline-title">Our nice super title</h4>
                            <p className="timeline-text">Lorem ipsum dolor site amet, consectetur adipscing elit, sed do eisumod tempor incididut ut labore et dolore magna aliqua. Ut enim ad mimim venjam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                        </div>
                    </div>
                    <div className="timeline-slide"  data-year="2010"> <span className="timeline-year">Saturday</span>
                        <div className="timeline-slide__content">
                            <h4 className="timeline-title">Our nice super title</h4>
                            <p className="timeline-text">Lorem ipsum dolor site amet, consectetur adipscing elit, sed do eisumod tempor incididut ut labore et dolore magna aliqua. Ut enim ad mimim venjam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                        </div>
                    </div>
                    <div className="timeline-slide" data-year="2012"> <span className="timeline-year">Sunday</span>
                        <div className="timeline-slide__content">
                            <h4 className="timeline-title">Our nice super title</h4>
                            <p className="timeline-text">Lorem ipsum dolor site amet, consectetur adipscing elit, sed do eisumod tempor incididut ut labore et dolore magna aliqua. Ut enim ad mimim venjam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                        </div>
