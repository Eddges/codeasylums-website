    ...
    <div className="containerCarousel">
        ...
        <div className="timeline">
            <div className="timeline-nav">
                ...
                <div className="timeline-nav__item" >Analysis</div>
            ...
            <div className="timeline-wrapper">
                <div className="timeline-slider">
                    ...
                    <div className="timeline-slide tuesday" style={{backgroundImage : `url(${caseStudy})`}} data-year="1988"> <span className="timeline-year">Problem Analysis</span>
                        <div className="timeline-slide__content">
                            <h4 className="timeline-title">Problem Solving and Analysis</h4>
