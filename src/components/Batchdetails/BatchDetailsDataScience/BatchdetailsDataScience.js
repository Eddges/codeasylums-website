...
const BatchdetailsDataScience = () => {
    return(
        ...
        {/* <!-- 2 --> */}
        <Box date = "05" month = "April"  coursename = "Data Science & Machine Learning" status = "Seats Filling" count = "13/15 students"/>
        {/* <!-- 3 --> */}
        <Box date = "05" month = "May"  coursename = "Data Science & Machine Learning" status = "Open" count = "7/15 students"/>
        {/* <!-- 4 --> */}
        <Box date = "05" month = "June"  coursename = "Data Science & Machine Learning" status = "Open" count = "5/15 students"/>
