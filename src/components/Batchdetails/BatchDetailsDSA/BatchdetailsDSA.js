...
const BatchdetailsDSA = () => {
    return(
        ...
        {/* <!-- 2 --> */}
        <Box date = "05" month = "Sept"  coursename = "Data Structures and Algorithms" status = "Seats Filling" count = "13/15 students"/>
        {/* <!-- 3 --> */}
        <Box date = "05" month = "Oct"  coursename = "Data Structures and Algorithms" status = "Open" count = "7/15 students"/>
        {/* <!-- 4 --> */}
        <Box date = "05" month = "Nov"  coursename = "Data Structures and Algorithms" status = "Open" count = "5/15 students"/>
