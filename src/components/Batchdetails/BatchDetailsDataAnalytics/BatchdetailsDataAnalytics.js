...
const BatchdetailsDataAnalytics = () => {
    return(
        ...
        {/* <!-- 2 --> */}
        <Box date = "05" month = "April"  coursename = "Data Analyst with Business Analysts" status = "Seats Filling" count = "13/15 students"/>
        {/* <!-- 3 --> */}
        <Box date = "05" month = "May"  coursename = "Data Analyst with Business Analysts" status = "Open" count = "7/15 students"/>
        {/* <!-- 4 --> */}
        <Box date = "05" month = "June"  coursename = "Data Analyst with Business Analysts" status = "Open" count = "5/15 students"/>
