...
const BatchdetailsFullStack = () => {
    return(
        ...
        {/* <!-- 2 --> */}
        <Box date = "20" month = "June"  coursename = "Full Stack Web Development" status = "Seats Filling" count = "13/15 students"/>
        {/* <!-- 3 --> */}
        <Box date = "18" month = "July"  coursename = "Full Stack Web Development" status = "Open" count = "7/15 students"/>
        {/* <!-- 4 --> */}
        <Box date = "16" month = "Aug"  coursename = "Full Stack Web Development" status = "Open" count = "5/15 students"/>
