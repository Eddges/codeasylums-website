...
const BatchdetailsFullStack = () => {
    return(
        ...
        {/* <!-- 2 --> */}
        <Box date = "05" month = "Sept"  coursename = "Full Stack Web Development" status = "Seats Filling" count = "13/15 students"/>
        {/* <!-- 3 --> */}
        <Box date = "05" month = "Oct"  coursename = "Full Stack Web Development" status = "Open" count = "7/15 students"/>
        {/* <!-- 4 --> */}
        <Box date = "05" month = "Nov"  coursename = "Full Stack Web Development" status = "Open" count = "5/15 students"/>
