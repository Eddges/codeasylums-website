    ...
    render() {
        ...
        return(
            <div className={classes.CurriculumFullStack} id="curriculum">
                ...
                <Curriculum2Item title="Week1" description="In your first week with CodeAsylums, you will be introduced to the basics of web technologies which include creating elements with HTML and styling with CSS. You will also learn about a lot of technologies used by developers all around." section={section1} />
                <Curriculum2Item title="Week 2" description="Now that you have been acquainted with the bare minimums of the web, it is time to write our first script. We will use the language of the web - JavaScript to hit APIs and to implement truly unique ideas and manipulate the elements to our will." section={section2} />
                <Curriculum2Item title="Week 3" description="Now acquainted with Front-End technologies, we will continue our journey to becoming a fullstack developer by learning about NodeJS, a high performance and highly scalable back-end environment. We will create our first server and make our own APIs." section={section3} />
                <Curriculum2Item title="Week 4" description="We will foray into the amazing world of cloud and host our website on the most popular cloud platform, Amazon's AWS. We will also learn about Databases, their principles and create efficient database systems for our projects." section={section4} />
                <Curriculum2Item title="Week 5" description="ReactJS is a front-end JavaScript framework that has truly taken the world by storm. Currently the most popular framework, we will take a deep dive into the framework and make use of its flexible features in our projects." section={section5} />
                <Curriculum2Item title="Week 6" description="Now that you are a fullstack developer who has command over both the frontend and backend technologies, it is time to put your skills to the work. In this final week, we focus on working on an idea of your choice and turning it into reality, by yourself!" section={section6} />
            </div>
